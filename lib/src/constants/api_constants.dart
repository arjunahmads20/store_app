...
class ApiConstants {
  static const String baseUrl = 'https://storeappxyz.pythonanywhere.com/api/v1'; // Be carefull to distinct http with https
...
final dioProvider = Provider<Dio>((ref) {
  final dio = Dio(BaseOptions(
    baseUrl: 'https://storeappxyz.pythonanywhere.com/api/v1', // Use 10.0.2.2 for Android Emulator if needed
